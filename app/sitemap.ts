...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/aktivitas/one-day-trip`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/aktivitas/diving-trip`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/aktivitas/sewa-motor`, changeFrequency: "weekly", priority: 0.8 },
