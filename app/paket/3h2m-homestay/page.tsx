...
export default async function Page() {
  ...
  const lowPrice = allSigPrices.length ? Math.min(...allSigPrices) * 1000 : 920000;
  const highPrice = allExpPrices.length ? Math.max(...allExpPrices) * 1000 : 1560000;
  ...
  const jsonLd = {
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEif66q-21j2DescKXC1QDHxvZONm_0z5SgCpe3qdJq20e0efVmhzEbsshxsvpK2OfcmS6rcSIoTsmLWR7uno1XHVg2PEaqrrVk8tjjL33JpCsEbp1F9yn24aPJpej9Ei9Jgule8rxqiGvkhvbt2FOZv2HC3tHQcVxlh2OoGveBbq8lalShdWy-Dyv57Ilo/s1600/DSC03967.webp",
  ...
  return (
    <div style={{ margin: "0 auto", maxWidth: 860, padding: "0 20px" }}>
      ...
      <div className="pkg-hero">
        ...
        <h1>Paket Wisata Karimunjawa 3 Hari 2 Malam - Homestay</h1>
        <p>
      ...
      <div className="pkg-desc">
        <p>
          Paket wisata Karimunjawa 3 hari 2 malam dengan homestay ini jadi pilihan
          paling hemat buat kamu yang tetap pengen ngerasain island hopping dan
          snorkeling lengkap di Karimunjawa. Kamu bisa pilih tipe kamar sesuai
          budget, mulai dari fan room kamar mandi luar sampai AC kamar mandi dalam,
          dengan kapasitas 1-4 orang. Selama 2 malam, kamu akan diajak tour
          darat ke Bukit Love dan pantai pasir putih, plus 1x tour laut full day
          untuk snorkeling dan berenang bareng hiu di sekitar Pulau Menjangan. Kalau
          mau penginapan dengan fasilitas lebih lengkap, cek juga{" "}
          <Link
            href="/paket/3h2m-hotel"
            className="font-semibold text-[#0a5c8a] underline"
          >
            paket 3 Hari 2 Malam Hotel
          </Link>{" "}
          ...
          sesuai jadwal dan bujet kamu di bawah. Semua sudah termasuk makan 4x
          (termasuk 1x BBQ ikan di pulau), sewa alat snorkeling, dan guide
          berlisensi HPI.
        </p>
      </div>
